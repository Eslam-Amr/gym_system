                ...
                <div class="row">
                    ...
                    <div class="col-12 my-4">
                        ...
                        <div class="card shadow">
                            <div class="card-body">
                                <form action="{{ route('admin.testmonials.store') }}" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <x-form-label filed="position" />

                                            <input type="text" id="example-position" name="position" class="form-control"
                                                placeholder="{{ __('keywords.position') }}">
                                            <x-input-error :messages="$errors->get('position')" class="mt-2" />

                                        </div>
                                        <div class="col-md-6">
                                            <x-form-label filed="image" />

                                            <input type="file" id="example-image" name="image" class="form-control-file">
