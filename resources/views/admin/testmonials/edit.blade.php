                        ...
                        <div class="card shadow">
                            <div class="card-body">
                                <form action="{{ route('admin.testmonials.update', $testmonial) }}" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <x-form-label filed="name" />

                                            <input type="text" id="example-name" name="name"
                                                value="{{ $testmonial->name }}" class="form-control"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" id="example-position" name="position"
                                                value="{{ $testmonial->position }}" class="form-control"
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" id="example-image" name="image"
                                                value="{{ $testmonial->image }}" class="form-control">
