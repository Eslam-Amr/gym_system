                                            ...
                                            @foreach ($services as $key => $service)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        {{-- <x-action-button href="{{ route('admin.services.edit', $service) }}" --}}
                                                            {{-- type="edit" /> --}}
                                                        {{-- <x-action-button href="{{ route('admin.services.show', $service) }}" --}}
                                                        {{-- type="show" /> --}}
                                                        {{--
                                                            <form class="d-inline" id="deleteForm-{{ $service->id }}"
