...
@section('title', __('keywords.edit_program'))
@section('content')
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">

                <h2 class="h5 page-title">{{ __('keywords.edit_program') }}</h2>

                <div class="row">
                    <!-- simple table -->
                    <div class="col-12 my-4">
@dump($program->benfits)
                                ...
                                <form action="{{ route('admin.programs.update', $program) }}" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mt-3">
                                            ...
                                            <input value="{{ $program->title }}" type="text" id="title" name="title" class="form-control"
                                        ...
                                        <div class="col-md-6 mt-3">
                                            ...
                                            <input value="{{ $program->slogan }}" type="text" id="slogan" name="slogan" class="form-control"
                                        ...
                                        <div class="col-md-6 mt-3">
                                            ...
                                            <input value="{{ $program->duration }}" min="0" max="12" type="number" id="durationInMonth"
                                        ...
                                        <div class="col-md-6 mt-3">
                                            ...
                                            <input value="{{ $program->limit }}" min="0" max="12" type="number" id="limit"
                                        ...
                                        <div class="col-md-6 mt-3">
                                            ...
                                            <input value="{{ $program->price }}" min="0" type="number" id="price" name="price"
                                        ...
                                        <div class="col-md-6 mt-3">
                                            ...
                                            <input value="{{ $program->discount }}" min="0" max="100" type="number" id="discount"
                                        ...
                                        <div class="col-md-6 mt-3">
                                                ...
                                                <input value="{{ $benfit->benfit }}" type="text" id="initialField" name="fields[]" class="form-control" placeholder="{{ __('keywords.Benfit') }}">
                                                <x-input-error :messages="$errors->get('initialField')" class="mt-2" />
                                            </div>
                                        @endforeach
                                        {{-- <div class="col-md-12 mt-3">
                                                <label for="initialField">{{ __('keywords.Benfit') }}</label>
                                                <input type="text" id="initialField" name="fields[]" class="form-control" placeholder="{{ __('keywords.Benfit') }}">
                                                <x-input-error :messages="$errors->get('initialField')" class="mt-2" />
                                            </div> --}}
                                        <div class="col-12">
                                                <div class="row" id="additionalFields"></div>
                                            </div>
                                            <button style="margin-left: 15px; padding: 5px; width: 30px; height: 30px; font-size: 16px;" class="btn btn-primary mt-3 btn-sm" type="button" id="addButton">+</button>

                                            <script>
                                                document.addEventListener('DOMContentLoaded', function() {
                                                    const maxFields = 10;
                                                    let fieldCount = {{ $program->benfits->count() }}; // Initial field is already present
