...
@section('title', __('keywords.nutritions'))
@section('content')
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between mb-3">
                    <h2 class="h5 page-title">{{ __('keywords.nutritions') }}</h2>
                    <div class="page-title-right">

                        {{-- <x-action-button href="{{ route('admin.nutritions.create') }}" type="create" /> --}}
                    </div>
                </div>
                <div class="row">
                    <!-- simple table -->
                                        ...
                                        @if (count($subscribers) > 0)
                                            @foreach ($subscribers as $key => $subscriber)
                                                <tr>
                                                    ...
                                                    <td>{{ $subscriber->to }}</td>
                                                    <td>
                                                          <x-action-button href="{{ route('admin.nutritions.edit', $subscriber) }}"
                                                        type="edit" />
                                                        <x-action-button href="{{ route('admin.nutritions.show', $subscriber) }}"
                                                        type="show" />
                                                </td>
                                              </td>
