        ...
        <div class="container">
            ...
            <div class="row">
                @foreach ($programs as $program)
                    {{-- <a href="{{ route('subscribe',$program) }}">
                    ...
                    {{--
<form action="{{ route('subscribe',$program) }}" method="POST">
@csrf
                    ...
                    <div class="col-lg-4">
                        <div class="single-price">
                            <div class="top-sec d-flex justify-content-between">
                                ...
                                <div class="top-right">
                                    <h4 style="text-decoration: line-through">EGP{{ $program->price }} </h4>
                                    <h6>{{ $program->discount }}%</h6>
                                    {{-- <x-display-price-after-discount  :price="{{ $program->price }}" /> --}}
                                    <x-display-price-after-discount price="{{ $program->price }}"
                            ...
                            <div class="bottom-sec">
                                ...
                                <p>
                                    number of free place : {{ $program->remain_place }}
                                </p>
                            </div>
                            <div class="end-sec">
                                <ul>
...
<a href="{{ route('subscribe',$program) }}">
    ...
    subscribe
                                ...
                                <form action="{{ route('subscribe.store', $program) }}" method="POST">
                                    @csrf
                                    <button class="primary-btn price-btn mt-20" type="submit"> subscribe
                                        <span class="lnr lnr-arrow-right"></span></button>
                                </form>
